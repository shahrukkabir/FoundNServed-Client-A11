...
const About = () => {
  ...
  return (
    <div id="about">
      ...
      <div className="bg-gray-600 p-10 rounded-lg shadow-md w-4/4 mx-auto text-center">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 w-3/4 mx-auto mt-5">
      ...
      <div className="w-4/4 mx-auto text-center mt-5">
        <h4 className="text-2xl font-semibold text-gray-800 mb-5">Meet Our Team</h4>
        <div className="flex justify-center gap-6 flex-wrap rounded-xl">
          <div className="bg-white p-4 rounded-lg shadow-xl w-40 text-center border">
            <img
              src={profile}
              alt="Team Member"
